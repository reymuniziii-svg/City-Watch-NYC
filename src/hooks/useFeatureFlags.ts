...
const ALL_FLAGS_ON: FeatureFlags = {
  ...
  canViewWorkHorse: true,
  canBenchmarkMembers: true,
  canViewCommitteeHeatmap: true,
  canViewBillProximity: true,
  canViewStakeholderMaps: true,
  canUseStafferDirectory: true,
  canUseInstitutionalMemory: true,
  canUseSemanticAnalysis: true,
  canUsePredictiveSchedule: true,
  canUseMondayBrief: true,
};
